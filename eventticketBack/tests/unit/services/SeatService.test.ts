...
import { SeatService } from "../../../src/services/seatService.ts";
import type { ISeatRepository } from "../../../src/interfaces/seatRepositoryInterface.ts";
import * as seatUtils from "../../../src/utils/seatUtils.ts";
...
describe("SeatService", () => {
  ...
  describe("getSeatById", () => {
    ...
    it("deve lançar erro quando assento não existe", async () => {
      ...
      await expect(seatService.getSeatById(99)).rejects.toThrow(
  ...
  describe("updateSeat", () => {
    it("deve atualizar assento quando existe", async () => {
      ...
      const updatedData = { status: "RESERVED" as const };
    ...
    it("deve lançar erro quando assento não existe", async () => {
      ...
      await expect(
        seatService.updateSeat(99, { status: "RESERVED" }),
      ).rejects.toThrow("Assento não encontrado");
  ...
  describe("deleteSeat", () => {
    ...
    it("deve lançar erro quando assento não existe", async () => {
      ...
      await expect(seatService.deleteSeat(99)).rejects.toThrow(
        "Assento não encontrado",
      );
