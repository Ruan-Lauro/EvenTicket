...
router.get("/:id", authMiddleware, requireRole("USER"), (req, res, next) =>
  shoppingCartController.getShoppingCartById(req, res, next),
);

router.get("/user/:id", authMiddleware, requireRole("USER"), (req, res, next) =>
  shoppingCartController.getShoppingCartByUserId(req, res, next),
);

router.put("/:id", authMiddleware, requireRole("USER"), (req, res, next) =>
